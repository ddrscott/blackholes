...
export default class Board extends Phaser.Scene {
    ...
    addPeg(peg, x, y) {
        ...
        if (target) {
            ...
            // const bonusText = this.add.text(x - y_increment*0.66, y - y_increment, 'x' + target.bonus, {
            //     // color: COLORS.lightHex,
            //     align: 'center', 
            //     fixedWidth: y_increment * 2,
            // }).setStroke(COLORS.outlineHex, 2);
            
            const bonusText = this.add.text(x - x_increment/3, y + x_increment * 1.25, 'x' + target.bonus, {
